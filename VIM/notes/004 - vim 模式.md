...
# 输入 jobs 查看后台作业
➜   jobs
[1]  + suspended  vim Projects/github/libNET/mars/mars/build_ios.py

# 输入 fg 将后台作业调入前台
➜   fg
[1]  + 65391 continued  vim Projects/github/libNET/mars/mars/build_ios.py
# vim 再次按下 <C-z> 临时退出
[1]  + 65391 suspended  vim Projects/github/libNET/mars/mars/build_ios.py
```
